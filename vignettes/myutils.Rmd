...
## 1.2 Download .nc files of marine environmental predictors using env_download() 
  ...
  If you are the first time to use copernicusmarine toolbox. You can first download an executable file (copernicusmarine.exe, from Github) of the copernicusmarine toolbox. See the download links in the “Step 2” of an official instruction at https://help.marine.copernicus.eu/en/articles/10750437-copernicus-marine-toolbox-executable-no-installation. 

  Step 2. Move it to a safe directory and register
  
  After download it, make sure you move it to a directory (e.g., "C:\shark") that you won't clean when you utilize storage cleaning up software. If you haven’t registered to the Copernicus Marine Service yet, you can register at https://data.marine.copernicus.eu/register.

  Step 3. Login to the Copernicus Marine Service
  
  Go to your command prompt and navigate to the executable file. For instance, if you are using Windows and the executable file is stored at "C:\shark", then in the command prompt, type: cd "C:\shark". Then type: copernicusmarine login. This will allow you to use your registered username and password to create a credential file (.copernicusmarine-credentials) and store it in your PC.
